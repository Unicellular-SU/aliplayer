...
class VidAuth extends _VidSourceBase {
  ...
  factory VidAuth.fromJson(Map<String, dynamic> json) =>
      _$VidAuthFromJson(json);
...
class LiveSts extends _SourceBase {
  ...
  factory LiveSts.fromJson(Map<String, dynamic> json) =>
      _$LiveStsFromJson(json);
...
class VidPlayerConfigGen {
  ...
  factory VidPlayerConfigGen.fromJson(Map<String, dynamic> json) =>
      _$VidPlayerConfigGenFromJson(json);
