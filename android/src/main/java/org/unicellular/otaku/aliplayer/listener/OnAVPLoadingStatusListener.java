...
//        eventSink.success(MapUtil.builder("event", (Object) "loadingBegin").build());
        eventSink.success(MapUtil.builder("event", (Object) "playEvent").put("value", 4).build());
    }

    @Override
    public void onLoadingProgress(int percent, float netSpeed) {
        //缓冲进度
        eventSink.success(MapUtil.builder("event", (Object) "loadingProgress").put("percent", percent).put("netSpeed", netSpeed).build());
...
//        eventSink.success(MapUtil.builder("event", (Object) "loadingEnd").build());
        eventSink.success(MapUtil.builder("event", (Object) "playEvent").put("value", 5).build());
